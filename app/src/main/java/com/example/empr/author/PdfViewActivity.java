...
import com.example.empr.databinding.ActivityPdfViewBinding;
...
public class PdfViewActivity extends AppCompatActivity {
    ...
    private void loadBookDetails() {
        Log.d(TAG, "loadBookDetails: Get Pdf URL from storage...");
                        ...
                        binding.pdfView.fromBytes(bytes)
                                ...
                                .onPageChange(new OnPageChangeListener() {
                                    ...
                                    public void onPageChanged(int page, int pageCount) {
                                        // set current total pages in toolbar subtitle
                                ...
                                .onPageError(new OnPageErrorListener() {
                                    ...
                                    public void onPageError(int page, Throwable t) {
                                        ...
                                        Toast.makeText(PdfViewActivity.this, "Error on page " + page + " " + t.getMessage(), Toast.LENGTH_LONG).show();
                                    }
                                })
                                .load();
